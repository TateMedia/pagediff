...
console.log("phantom.js processing options:");
console.log(processing_options.threshold);
...
function compare(before_filename, after_filename, output_filename, size, options) {
    ...
    var id = setInterval(function () {
      ...
      if (title == "done") {
        ...
        if (!options.threshold || stats.percentage >= options.threshold) {
          console.log(stats.percentage + " >= " + options.threshold);
          grab();
        } else {
          quit();
        }
